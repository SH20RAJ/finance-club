       ...
       <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-16">
             <Reveal variant="fade-up">
                <h1 className="font-handwritten text-6xl md:text-9xl font-bold mb-4 rotate-[-2deg]">
          ...
          {flagshipEvent && (
             <Reveal variant="scale-up" duration={0.8} className="mb-20">
                 <div className="bg-zinc-900 text-white rounded-3xl p-8 md:p-16 relative overflow-hidden group border-4 border-fin-red shadow-[12px_12px_0px_0px] shadow-zinc-400 dark:shadow-zinc-800">
                    {/* Decoration */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             {otherEvents.map((event, i) => (
                <Link href={`/events/${event.slug}`} key={event.id}>
                   <Reveal variant="fade-up" delay={i * 0.1} className="h-full">
                       <div className="bg-white dark:bg-zinc-900 border-2 border-zinc-900 dark:border-white p-8 h-full hover:-translate-y-2 hover:shadow-[8px_8px_0px_0px] hover:shadow-fin-blue transition-all group">
